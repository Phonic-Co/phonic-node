...
export interface UpsertAgentRequest {
    ...
    audio_format?: UpsertAgentRequest.AudioFormat;
    ...
    template_variables?: Record<string, UpsertAgentRequest.TemplateVariables.Value>;
    /** Array of built-in or custom tool names to use. */
    tools?: UpsertAgentRequest.Tools.Item[];
    ...
    configuration_endpoint?: UpsertAgentRequest.ConfigurationEndpoint;
}

export namespace UpsertAgentRequest {
    /**
     * The audio format of the agent.
     */
